        ...
        <div className="container mt-5">
            <div className="jumbotron">
                ...
                <p className="lead d-flex">
                    <Link className="btn btn-primary btn-lg m-2" to="/countdown" role="button">
                    Countdown Timer
                    </Link>
                    <Link className="btn btn-primary btn-lg m-2" to="/converter" role="button">
                    Currency Converter
                    </Link>
                    <Link className="btn btn-primary btn-lg m-2" to="/salarycalc" role="button">
                    Salary Calculator
                    </Link>
                    <Link className="btn btn-primary btn-lg m-2" to="/wordscramble" role="button">
                    Word Scramble
                    </Link>
                </p>
            </div>
